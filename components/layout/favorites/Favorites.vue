...
const { data: favoriteProducts = [], isPending: isPendingFavoriteProducts, isError: isErrorFavoriteProducts } = useGetFavoriteProducts();
...
<template>
	<div role="dialog" aria-labelledby="cart-title" :aria-hidden="!sidebarStore.isFavoritesOpen"
		:class="['fixed top-[120px] right-0 h-[57.7vh] w-[34vw] bg-white py-6 flex flex-col z-50', favoritesClasses]">
		<!-- Header -->
		<h1 id="cart-title" class="font-light text-center mb-[43px] text-[32px]">Wishlist</h1>
