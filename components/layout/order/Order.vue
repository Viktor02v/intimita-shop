...
<template>
	<div :class="sidebarStore.isOrderOpen
			? 'translate-y-0 duration-700 opacity-100 fixed top-0 left-0 w-full h-full z-50 text-white'
			: '-translate-y-full duration-700 opacity-100 fixed top-0 left-0 w-full h-full z-50 text-white'
		" v-if="items && items?.length > 0">
		<div class="w-full h-full bg-black text-white z-50 flex flex-col justify-center items-center">
