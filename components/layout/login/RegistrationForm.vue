...
<template>
  <form class="w-full md:text-black text-white">
    <UiInput
      v-model="authStore.nameRef"
    ...
    <UiInput
      v-model="authStore.emailRef"
      placeholder="Email"
      type="email"
      class="input"
    />
    <UiInput
      v-model="authStore.passwordRef"
...
<style scoped>
.input {
  @apply mb-4 placeholder:text-gray-300 placeholder:text-[12px] md:text-black text-white border-b border-gray-300 focus-visible:ring-0 focus:outline-none;
}
</style>
