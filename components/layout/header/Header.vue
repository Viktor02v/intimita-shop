...
<template>
	<div class="fixed top-0 left-0 min-h-[120px] max-h-[120px] bg-black w-full z-50">
		<div class="flex items-center min-h-[120px] max-h-[120px] px-[85px] relative">
			<button>
				<Icon @click="onSearchStore.isSearchOpen = true" v-if="!onSearchStore.isSearchOpen" name="ion:search"
					class="text-[26px] text-gray-200 hover:text-[#FFD095] absolute bottom-3/9 left-1/8 -translate-x-1/2 -translate-y-1/2" />
				<div class="absolute bottom-1/3 left-1/9 -translate-x-1/9 flex items-center text-[#989898]" v-else>
